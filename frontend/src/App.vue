...
onMounted(() => {
  ...
  console.log("Слайдів знайдено:", sliders.length);
  console.log("Крапок знайдено:", dots.length);
  ...
  function showSlider(index: number) {
    ...
    for (let i = 0; i < dots.length; i++) {
      dots[i].classList.remove('border-2', 'border-white', 'bg-orange-500');
    }

    sliders[index].classList.remove('hidden');
    sliders[index].classList.add('block');

    dots[index].classList.add('border-2', 'border-white', 'bg-orange-500');
  }
...
<template>
    ...
    <div class="max-w-7xl mx-auto">
      <div class="py-1.5 flex">
        <div class="grow text-center">
          <p class="font-poppins lg:text-sm text-xs text-white">
            Summer Sale For All Swim Suits And Free Express Delivery - OFF 50%!
            <a href="#" class="font-semibold underline ml-2">ShopNow</a>
          </p>
        </div>
        <div id="dropdown" class="hidden lg:block relative group">
          <a href="#" class="text-xs lg:text-sm text-white font-poppins flex justify-center items-center h-full">
            English
            <svg class="ml-2.5" width="12.728027" height="7.778000" viewBox="0 0 12.728 7.778" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <path id="Vector" d="M6.36 4.94L11.31 0L12.72 1.41L6.36 7.77L0 1.41L1.41 0L6.36 4.94Z" fill="#FFFFFF" fill-opacity="1.000000" fill-rule="nonzero"/>
            </svg>
          </a>
          <ul class="absolute hidden group-hover:block z-10">
            <li class="bg-black p-1.5">
              <a href="#" class="block text-sm text-white">Українська</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="py-2 max-w-7xl mx-auto">
      <div class="flex justify-between items-end">
        <div class="lg:hidden block cursor-pointer">
          <span class="pi pi-bars" id="openButton"></span>
        </div>
        <div class="lg:hidden fixed top-0 left-0 bottom-0 w-2/3 z-10 -translate-x-full transition delay-300 border-2 border-gray-300 bg-white" id="menu">
          <div class="bg-gray-400">
            <div class="flex justify-end items-center">
              <div id="dropdown" class="relative group">
                <a href="#" class="text-sm text-white font-poppins flex justify-center items-center h-full">
                    English
                  <svg class="ml-2.5" width="12.728027" height="7.778000" viewBox="0 0 12.728 7.778" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <path id="Vector" d="M6.36 4.94L11.31 0L12.72 1.41L6.36 7.77L0 1.41L1.41 0L6.36 4.94Z" fill="#FFFFFF" fill-opacity="1.000000" fill-rule="nonzero"/>
                  </svg>
                </a>
                <ul class="absolute hidden group-focus-within:block z-10">
                  <li class="bg-black p-1.5">
                    <a href="#" class="block text-sm text-white">Українська</a>
                  </li>
                </ul>
              </div>
              <span class="pi pi-times ml-4" id="cancelButton"></span>
            </div>
          </div>
          <div class="flex justify-center items-center py-3 border-b-2 border-b-gray-300">
            <button class="bg-green-500 px-10 py-4 rounded-sm">Каталог товарів</button>
          </div>
          <ul class="list-none pt-5">
            <li class="mb-4">
              <a href="#" class="flex items-center">
                ...
                <div class="ml-4 grow">
                  <p class="font-poppins text-sm">My Wishlist</p>
                </div>
                <div class="bg-green-500 rounded-full w-4 h-4 flex justify-center items-center">
                  <p class="font-poppins text-sm text-white">1</p>
                </div>
              </a>
            </li>
            <li>
                ...
                <svg width="32.000000" height="32.000000" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <defs>
                    <clipPath id="clip399_1918">
                      <rect id="user" width="32.000000" height="32.000000" fill="black" fill-opacity="0"/>
                    </clipPath>
                  </defs>
                  <rect id="user" width="32.000000" height="32.000000" fill="#FFFFFF" fill-opacity="0"/>
                    <g clip-path="url(#clip399_1918)">
                      <path id="Vector" d="M24 27L24 24.33C24 22.91 23.52 21.56 22.67 20.56C21.82 19.56 20.66 19 19.46 19L11.53 19C10.33 19 9.17 19.56 8.32 20.56C7.47 21.56 7 22.91 7 24.33L7 27" stroke="#000000" stroke-opacity="1.000000" stroke-width="1.500000" stroke-linejoin="round" stroke-linecap="round"/>
                      <path id="Vector" d="M16.5 14C14.01 14 12 11.98 12 9.5C12 7.01 14.01 5 16.5 5C18.98 5 21 7.01 21 9.5C21 11.98 18.98 14 16.5 14Z" stroke="#000000" stroke-opacity="1.000000" stroke-width="1.500000" stroke-linejoin="round"/>
                    </g>
                </svg>
                <div class="ml-4">
                  <p class="font-poppins text-sm">Manage My Account</p>
                </div>
              </a>
            </li>
            <li class="mt-4">
                ...
                <svg width="24.000000" height="24.000000" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <defs>
                    <clipPath id="clip399_1924">
                      <rect id="icon-mallbag" width="24.000000" height="24.000000" fill="black" fill-opacity="0"/>
                    </clipPath>
                  </defs>
                  <rect id="icon-mallbag" width="24.000000" height="24.000000" fill="#000000" fill-opacity="0"/>
                  <g clip-path="url(#clip399_1924)">
                    <path id="Vector" d="M3 20.5C3 20.76 3.1 21.01 3.29 21.2C3.48 21.39 3.73 21.5 4 21.5L20 21.5C20.26 21.5 20.51 21.39 20.7 21.2C20.89 21.01 21 20.76 21 20.5L21 6.3L3 6.3L3 20.5Z" stroke="#000000" stroke-opacity="1.000000" stroke-width="1.500000" stroke-linejoin="round"/>
                    <path id="Vector" d="M21 6.3L18.16 2.5L5.83 2.5L3 6.3M15.77 9.6C15.77 11.69 14.08 13.4 12 13.4C9.91 13.4 8.22 11.69 8.22 9.6" stroke="#000000" stroke-opacity="1.000000" stroke-width="1.500000" stroke-linejoin="round" stroke-linecap="round"/>
                  </g>
                </svg>
                <div class="ml-4">
                  <p class="font-poppins text-sm">My Order</p>
                </div>
              </a>
            </li>
            <li class="mt-4">
                ...
                <svg width="24.000000" height="24.000000" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <defs>
                    <clipPath id="clip399_1929">
                      <rect id="icon-cancel" width="24.000000" height="24.000000" fill="black" fill-opacity="0"/>
                    </clipPath>
                  </defs>
                  <rect id="icon-cancel" width="24.000000" height="24.000000" fill="#000000" fill-opacity="0"/>
                  <g clip-path="url(#clip399_1929)">
                    <path id="Vector" d="M8 16L12 12L16 16M16 8L11.99 12L8 8" stroke="#000000" stroke-opacity="1.000000" stroke-width="1.500000" stroke-linejoin="round" stroke-linecap="round"/>
                    <circle id="Ellipse 26" cx="12.000000" cy="12.000000" r="11.250000" stroke="#000000" stroke-opacity="1.000000" stroke-width="1.500000"/>
                  </g>
                </svg>
                <div class="ml-4">
                  <p class="font-poppins text-sm">My Cancellations</p>
                </div>
              </a>
            </li>
            <li class="mt-4">
            ...
            <li class="mt-4">
              <a href="#" class="flex items-center">
                <svg width="24.000000" height="24.000000" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  ...
                  <rect id="Icon-logout" width="24.000000" height="24.000000" transform="matrix(-1 0 0 1 24 0)" fill="#000000" fill-opacity="0"/>
                    <g clip-path="url(#clip399_1937)">
                      <path id="Vector" d="M4 12L13.5 12M6 15L3 12L6 9M11 7L11 6C11 5.46 11.21 4.96 11.58 4.58C11.96 4.21 12.46 4 13 4L18 4C18.53 4 19.03 4.21 19.41 4.58C19.78 4.96 20 5.46 20 6L20 18C20 18.53 19.78 19.03 19.41 19.41C19.03 19.78 18.53 20 18 20L13 20C12.46 20 11.96 19.78 11.58 19.41C11.21 19.03 11 18.53 11 18L11 17" stroke="#000000" stroke-opacity="1.000000" stroke-width="1.500000" stroke-linejoin="round" stroke-linecap="round"/>
                    </g>
                </svg>
                <div class="ml-4">
                  <p class="font-poppins text-sm">Logout</p>
                </div>
              </a>
            </li>
          </ul>
        ...
        <div>
          <h2 class="font-inter text-xl lg:text-2xl font-bold">Exclusive</h2>
        </div>
        <div class="lg:block hidden">
          <nav class="list-none flex">
            <li class="group mr-12">
        ...
        <div class="flex">
          <div class="relative">
            <input type="text" class="rounded-sm bg-gray-100 py-1 pl-5 pr-12 lg:text-base text-sm h-full" placeholder="What are you looking for?">
            <div class="absolute flex h-full items-center right-1 top-0">
              <button class="cursor-pointer h-full w-8">
                <span class="pi pi-search text-sm"></span>
              </button>
            </div>
          </div>
          <div class="hidden lg:flex lg:justify-center lg:items-center w-8 relative rounded-full focus:bg-red-500 ml-2 cursor-pointer" tabindex="0">
            <span class="pi pi-heart text-xl"></span>
          ...
          <div class="relative flex justify-center items-center rounded-full focus:bg-red-500 ml-2 w-8 h-8 cursor-pointer" tabindex="1">
            <span class="pi pi-shopping-cart text-xl"></span>
            <div class="rounded-full absolute top-0 right-0 flex justify-center items-center w-4 h-4 bg-red-500">
              <p class="text-white font-poppint text-xs">2</p>
            </div>
          </div>
          <div class="hidden group relative lg:flex lg:justify-center lg:items-center rounded-full focus:bg-red-500 ml-2 w-8 h-8 cursor-pointer" tabindex="2">
  ...
  <div>
    <div class="max-w-7xl mx-auto">
      <div class="flex">
        <div class="w-1/4 border-r-2 border-r-gray-300 pt-10">
          <ul class="list-none">
              <li>
                <a href="#" class="flex">
                  <div class="grow">
                    <p class="font-poppins">Woman’s Fashion</p>
                  </div>
                  <div class="flex justify-center items-center pr-4">
                    <span class="pi pi-chevron-right w-6"></span>
                  </div>
                </a>
              </li>
              <li class="mt-4">
                <a href="#" class="flex">
                  <div class="grow">
                    <p class="font-poppins">Men’s Fashion</p>
                  </div>
                  <div class="flex justify-center items-center pr-4">
                    <span class="pi pi-chevron-right w-6"></span>
                  </div>
              ...
              <li class="mt-4">
                <a href="#" class="flex">
                  <div class="grow">
                    <p class="font-poppins">Electronics</p>
                  </div>
                  <div class="flex justify-center items-center pr-4">
                    <span class="pi pi-chevron-right w-6"></span>
                  </div>
              ...
              <li class="mt-4">
                <a href="#" class="flex">
                  <div class="grow">
                    <p class="font-poppins">Home & Lifestyle</p>
                  </div>
                  <div class="flex justify-center items-center pr-4">
                    <span class="pi pi-chevron-right w-6"></span>
                  </div>
              ...
              <li class="mt-4">
                <a href="#" class="flex">
                  <div class="grow">
                    <p class="font-poppins">Medicine</p>
                  </div>
                  <div class="flex justify-center items-center pr-4">
                    <span class="pi pi-chevron-right w-6"></span>
                  </div>
              ...
              <li class="mt-4">
                <a href="#" class="flex">
                  <div class="grow">
                    <p class="font-poppins">Sports & Outdoor</p>
                  </div>
                  <div class="flex justify-center items-center pr-4">
                    <span class="pi pi-chevron-right w-6"></span>
                  </div>
              ...
              <li class="mt-4">
                <a href="#" class="flex">
                  <div class="grow">
                    <p class="font-poppins">Baby’s & Toys</p>
                  </div>
                  <div class="flex justify-center items-center pr-4">
                    <span class="pi pi-chevron-right w-6"></span>
                  </div>
              ...
              <li class="mt-4">
                <a href="#" class="flex">
                  <div class="grow">
                    <p class="font-poppins">Groceries & Pets</p>
                  </div>
                  <div class="flex justify-center items-center pr-4">
                    <span class="pi pi-chevron-right w-6"></span>
                  </div>
              ...
              <li class="mt-4">
                <a href="#" class="flex">
                  <div class="grow">
                    <p class="font-poppins">Health & Beauty</p>
                  </div>
                  <div class="flex justify-center items-center pr-4">
                    <span class="pi pi-chevron-right w-6"></span>
                  </div>
        ...
        <div class="w-3/4">
          <div class="relative pt-10 pl-10 h-full">
            <div class="bg-black h-full slider">
              <div class="flex justify-between">
                <div class="pt-10 pl-10">
                  ...
                  <div class="mt-5">
                    <h2 class="text-white font-inter text-5xl font-semibold">Up to 10% <br>off Voucher</h2>
                  </div>
                  <div class="mt-5">
                    <a href="#" class="flex items-center">
                ...
                <div class="">
                  <img src="./assets/images/slider/phone.png" alt="">
                </div>
              </div>
            </div>
            <div class="bg-gray-400 hidden h-full slider">
              <div>
